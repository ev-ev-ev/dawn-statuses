...
# TODO: This may be nearly impossible to extract, due to the intermingling of scene modifiers and techniques
def newEdge():
    return {
        'name': '',
        'flavor': '',
...
def extract(sourcebook, startpage, endpage):
    ...
    for line in techniques.splitlines():
        ...
        if m:
            current['turnname'] = m.group(1)
            current['turn'] = m.group(2)
            currenttype = 'turn'
            continue
